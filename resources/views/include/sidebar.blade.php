<div class="sidebar-wrapper sidebar-theme">
    ...
    <nav id="compactSidebar">
        ...
        <ul class="menu-categories">
            ...
            <li class="menu menu-single active">
                <a href="/farmers_list" data-active="true" class="menu-toggle">
                    <div class="base-menu">
                        <div class="base-icons">
                ...
                <div class="tooltip"><span>Farmer List</span></div>
            </li>

            <li class="menu menu-single active">
                <a href="/pilot_list" data-active="true" class="menu-toggle">
                    <div class="base-menu">
                        <div class="base-icons">
                ...
                <div class="tooltip"><span>Pilot List</span></div>
            </li>

            <li class="menu menu-single active">
                <a href="/drone_list" data-active="true" class="menu-toggle">
                    <div class="base-menu">
                        <div class="base-icons">
                ...
                <div class="tooltip"><span>Drone List</span></div>
            </li>



            <li class="menu menu-single">
                <a href="/show_import" data-active="false" class="menu-toggle">
                    <div class="base-menu">
                        <div class="base-icons">
                ...
                <div class="tooltip"><span>Import Excel</span></div>
            </li>
        ...
        <div class="sidebar-bottom-actions">
            ...
            <div class="dropdown user-profile-dropdown">
                <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="userProfileDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img src="assets/img/90x90.jpg" class="img-fluid" alt="avatar">
                </a>
